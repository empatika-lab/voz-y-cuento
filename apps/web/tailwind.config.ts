...
module.exports = {
	...
	theme: {
		extend: {
			...
			backgroundImage: {
				'gradient-2':
					'linear-gradient(103deg, #B6E8E9 11.95%, #EADACA 53.96%, #F6B8B3 97.05%)',
				'gradient-3':
					'linear-gradient(0.11deg, #E8F8F8 0.1%, rgba(232, 248, 248, 0.21) 101.24%)',
				'gradient-4':
				...
				'gradient-diamond':
					'linear-gradient(180deg, rgba(15,129,131,1) 0%, rgba(9,76,77,1) 100%)',
			},
			colors: {
				cyan: {
					25: '#f8fdfd',
