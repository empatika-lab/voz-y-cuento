			...
			<div className="flex w-full flex-col items-center justify-between lg:flex-row">
				...
				<div className="mt-4 w-full text-center lg:mt-0 lg:w-[592px] lg:text-right">
					...
					<p className="text-left text-base text-gray-900 lg:mt-12 lg:text-right lg:text-xl">
						Te invito a conocer mi historia narrativa. Desde mi trayectoria como
						docente de nivel inicial a convertirme en narradora oral escénica
						profesional con más de diez años de experiencia.
					</p>
