...
export default function Hire() {
	return (
		<section className="relative py-[192px] lg:py-[257px]">
			<NextImage alt="contrataciones" className="h-full w-full object-cover" fill src={HireImage} />

			<div className="absolute inset-0 bg-gradient-4 lg:bg-gradient-4" />

			<div className="container">
				<h1 className="relative font-display text-4xl leading-[1.2] lg:text-7xl ">
