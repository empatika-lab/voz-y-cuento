	...
	return (
		<section className="relative py-12 lg:py-[257px]">
			...
			<div className="container">
				<h2 className="relative font-display subtitle">Espectáculos</h2>
				<p className="relative mt-6 text-black lg:mt-12 lg:max-w-2xl lg:text-2xl max-w-[75%]">
					Opciones de espectáculos presenciales y/o virtuales para tu evento o proyecto escolar.
				</p>

				<Button
					className="relative mr-auto lg:mx-auto block w-fit mt-12 text-center hover:bg-cyan-500 active:bg-cyan-500 lg:ml-0"
					href="/espectaculos"
					variant="outline"
				>
					Ver catálogo
